          ...
          <div class="position-relative pt-10 pb-8">
            <div class="header-text">
              <div class="overflow-hidden">
                <h1 class="display-3 text-white font-weight-extra-light ls-1" data-zanim-xs='{"duration":2,"delay":0}'>STUDENT LOGIN PAGE</h1>
              </div>
              <div class="overflow-hidden">
      ...
      <section>
        ...
        <div class="container">
          ...
          <div class="row mb-4" data-zanim-timeline="{}" data-zanim-trigger="scroll" align="center" id="LOGIN">
            <div class="col">
              <div class="overflow-hidden">
                <h2 class="fs-sm-5 mb-2" data-zanim-xs='{"duration":1.5,"delay":0}'>LOGIN</h2>
              </div>
              <div class="overflow-hidden">
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              <div class="mb-6">
                        ...
                        <?=form_open(base_url('index.php/login_control'), 'role="form"'); ?>
                            ...
                            <div class="form-group">
								<?=form_password('user_pass', '', 'id="user_pass" placeholder="Password" type="password" class="form-control" required="required"') ?>
                            </div>
